...
In this and future lessons, the solution can be download and installed with
the command `npm install` from the command line / terminal in the package
folder, e.g,. in this case *lesson_1*.
